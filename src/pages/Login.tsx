    ...
    <div className="min-h-screen pt-24 pb-12 flex flex-col items-center justify-center px-4 bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">স্বাগতম!</h1>
          <p className="text-slate-500 dark:text-slate-400">আপনার অ্যাকাউন্টে লগইন করুন</p>
        </div>
